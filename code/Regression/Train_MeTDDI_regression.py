...
tr_dataset = pd.read_csv('/data/Regression/tr_datset_regression.csv')
val_dataset = pd.read_csv('/data/Regression/data/val_datset_regression.csv')
tst_dataset = pd.read_csv('/data/Regression/data/PKDDI_info_2023_FDA_external.csv')
...
filepath = '/code/Regression/saved_weights/weights_for_regression.h5'
